...
export default function TeamDetailPage() {
  ...
  if (loading) return <Layout><div className="p-8 text-center">Lade Teamdaten…</div></Layout>;
  if (!team) return <Layout><div className="p-8 text-center text-red-500">Team nicht gefunden.</div></Layout>;
