...
import { ShieldCheck, List, Building2, ClipboardCheck, Bug, Activity, Users, Settings2, Server, BarChart2 } from "lucide-react";
...
export default function SuperadminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      {/* Sidebar */}
      <aside className="w-64 bg-white shadow-md flex flex-col min-h-screen sticky top-0 z-40">
