...
import {
  ...
  List,
  Folder,
  User as UserIcon,       // Für „Profil“-Link
  LogOut as SignOutIcon,  // Kann man ebenfalls verwenden, wenn man mag
} from "lucide-react";

const links = [
  { href: "/team/settings", label: "Allgemein",    icon: <Settings /> },
  { href: "/team/account",  label: "Profil",       icon: <UserIcon /> },   // Neuer Menüpunkt
  ...
  { href: "/team/files",    label: "Dokumente",    icon: <Folder /> },     // Ablage für BR
