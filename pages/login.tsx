    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      >
        ...
        >
          ...
          >
            <path d="M533.5 278.4c0-17.4-1.6-34.2-4.6-50.4H272v95.3h147.3c-6.3 34-25 62.7-53.3 82v67h86.2c50.4-46.4 81.3-114.9 81.3-193.9z" fill="#4285F4" />
            <path d="M272 544.3c72.9 0 134.1-24.1 178.8-65.5l-86.2-67c-24 16-54.7 25.4-92.6 25.4-71.2 0-131.5-48-153.2-112.4H31.7v70.5c44.8 89 137.5 149 240.3 149z" fill="#34A853" />
            <path d="M118.8 324.8c-10.5-31.5-10.5-65.6 0-97.1V157.2H31.7c-38.9 77.8-38.9 170.1 0 247.9l87.1-70.3z" fill="#FBBC05" />
            <path d="M272 107.7c39.6-.6 77.4 14 106.3 40.4l79.4-79.4C416.1 24.3 345.5-2.4 272 0 169.3 0 76.5 60 31.7 149l87.1 70.2c21.7-64.4 82-112.4 153.2-111.5z" fill="#EA4335" />
          </svg>
